...
Navbar responsive
- CSS thuần (từ PBT trước) — khoảng 80 dòng CSS:
...
/* ... hover, active, transition, z-index... */

- Bootstrap — 0 dòng CSS, chỉ HTML classes:
...
Số dòng CSS cho navbar          ~80 dòng                    0 dòng CSS  
Số dòng CSS cho product card    ~50 dòng                    0 dòng CSS
Thời gian phát triển            Chậm hơn (tự viết mọi thứ)  Nhanh hơn 3–5 lần
Khả năng tùy biến               Cao — tự do hoàn toàn       Trung bình — cần override SCSS
File size                       Nhỏ (chỉ CSS cần dùng)      Lớn hơn (~30KB minified)
Học thuộc                       Ít hơn                      Nhiều class cần nhớ
Giao diện                       Tự thiết kế                 Mặc định trông "giống Bootstrap"

- Khi nào NÊN dùng Bootstrap?
    + Dự án cần làm nhanh (MVP, prototype, hackathon)
    + Team không có designer — Bootstrap cho giao diện đủ đẹp mặc định
    + Trang admin/dashboard nội bộ — không cần thiết kế độc đáo
    + Nhiều developer cùng làm, cần convention chung

- Khi nào KHÔNG NÊN dùng Bootstrap?
    + Trang landing page cần thiết kế độc đáo, khác biệt — Bootstrap trông "generic"
    + Dự án rất nhỏ (1-2 pages) — load cả Bootstrap chỉ để dùng 10% là lãng phí
    + Khi đang học CSS — dùng Bootstrap sớm sẽ không hiểu cơ chế bên dưới
    + Dự án cần tối ưu performance cao — Bootstrap mang nhiều CSS không dùng đến